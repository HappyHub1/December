...
function chatSocket(data) {
	if (data.meta.addClass !== "server-whisper") {
		aMessages[aMessages.length] = [data.time, data.username, data.msg.replace(/<a.+href="(.+?)".+<\/a>/gi, "$1").replace(/ <span style="display:none" class="teamColorSpan">.+/gi,""), data.msg.match(/Ð(.+?)Ð/)[1] || ""];
